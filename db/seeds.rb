...
e = Event.create(user: u1, organization: o, location: "Event Location 1", minimum_guest: 20, event_rule: true, banner_picture: "banner1", title: "Event Name1", description: "Description Event 1")
ImageEventPage.create(event: e, image: "image1")
VideoEventPage.create(event: e, video: "video1")
...
Comment.create(event_invitation: ei2, event: e, content: "Comment2")
Comment.create(event_invitation: ei2, event: e, commented_id: 1,content: "Comment1Reply")
...
e = Event.create(user: u1, organization: o, location: "Event Location 2", minimum_guest: 10, event_rule: false, hidden: true, banner_picture: "banner2", title: "Event Name2", description: "Description Event 2")
ImageEventPage.create(event: e, image: "image2")
ImageEventPage.create(event: e, image: "image3")
VideoEventPage.create(event: e, video: "video2")
...
e = Event.create(user: u2, location: "Event Location 3", minimum_guest: 50, event_rule: true, banner_picture: "banner3", title: "Event Name3", description: "Description Event 3")
VideoEventPage.create(event: e, video: "video3")
PdfEventPage.create(event: e, pdf: "pdf2")
